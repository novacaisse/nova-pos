// Hub "Applications" — réservé au propriétaire (owner) : bascule entre les
// applications ZegOS actives sur l'organisation courante, et active/désactive
// les modules disponibles (aujourd'hui : ZegHotel, en plus de ZegCaisse déjà
// actif par défaut). Écrit directement organizations.active_apps (RLS
// shops_update autorise déjà owner/manager — restreint à owner ici côté UI
// puisque c'est une décision qui change ce que voit toute l'équipe).
...
function ApplicationsPage() {
  ...
  return (
    <div>
      <PageHeader title="Applications" subtitle="Les applications ZegOS actives sur cette organisation" />
