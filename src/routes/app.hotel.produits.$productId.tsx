...
export const Route = createFileRoute("/app/hotel/produits/$productId")({
...
function EditProduitPage() {
  ...
  return <ProductForm initial={product} cats={cats} canManage={canManage} basePath="/app/hotel/produits" />;
}
